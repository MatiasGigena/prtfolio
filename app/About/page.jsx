  ...
  return (
    <div className="min-h-screen w-full bg-white text-sec flex flex-col justify-center items-center">
      <div ref={ref} className="h-[170vh] flex  overflow-hidden gap-[6vw] p-[2vw] box-border">
        <Column
          myImages={[myImages[0], myImages[1], myImages[2], myImages[3], myImages[4], myImages[5], myImages[15]]}
          y={y}
        />
        <Column
          myImages={[myImages[6], myImages[7], myImages[8], myImages[9], myImages[10], myImages[11], myImages[16]]} y={y2}
        />
        <Column
          myImages={[myImages[10], myImages[11], myImages[12], myImages[13], myImages[14], myImages[15], myImages[17]]} y={y3}
        />
      </div>
    </div>
  );
...
const Column = ({ myImages, y = 0 }) => {
  return (
    <motion.div style={{ y }} className="w-1/3 h-full column relative flex flex-col gap-[2vw] min-w-[250px]">
