...
const Modal = ({ modal, projects }) => {
  ...
  return (
    <>
      ...
      <motion.div ref={cursor} variants={scaleAnimation} initial={"initial"} animate={active ? "open" : "closed"} className="w-24 h-24 flex items-center fixed bg-red-600 shadow-xl rounded-full pointer-events-none justify-center text-sec"></motion.div>
