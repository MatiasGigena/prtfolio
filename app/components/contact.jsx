...
const Contact = () => {
  ...
  return (
    <motion.section ref={container} initial="initial" variants={loader} animate={isInView3 ? "open" : ""} className="text-gray-600 lg:border-0 lg:rounded-b-full lg:border-b-2 border-2 xxl:h-[80vh] rounded-xl w-full mt-60 lg:mt-0 md:mt-96 body-font relative">
