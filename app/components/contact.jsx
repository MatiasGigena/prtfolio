...
const Contact = () => {
  ...
  return (
    ...
    >
      <div
        id='Contact'
        className='container px-5 border-0 lg:pt-11 lg:pb-4 pt-6 pb-3 mx-auto'
      >
        <div className='flex flex-col text-center w-full  mb-12'>
          ...
          <motion.p
            ...
            initial='initial'
            variants={animate5}
            animate={isInView5 ? 'open' : ''}
            className='lg:w-2/3 mx-auto text-white leading-relaxed text-base'
          >
            I hope you&apos;ve found inspiration along the
            way. Let&apos;s connect.
          </motion.p>
        </div>
              ...
              <div className='p-2 w-full'>
                <Magnetic>
                  <button
                    ...
                    className='flex hvr-radial-out mx-auto bg-white text-black border-2 py-2 px-8 rounded text-lg'
                  >
                    Send
                  </button>
                </Magnetic>
