...
function Icon({ path, size = 24, ...props }: IconProps): JSX.Element {
  return (
    <svg
      aria-hidden='true'
      focusable='false'
...
export function MenuIcon(props: Omit<IconProps, 'path'>): JSX.Element {
  return <Icon path='M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z' {...props} />;
}

export function AnimationIcon(props: Omit<IconProps, 'path'>): JSX.Element {
  return (
    <Icon
...
export function ExpandCircleDownIcon(props: Omit<IconProps, 'path'>): JSX.Element {
  return (
    <Icon
      path='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 13.5L7.5 11l1.42-1.41L12 12.67l3.08-3.08L16.5 11 12 15.5z'
      {...props}
    />
  );
}

export function LinkedInIcon(props: Omit<IconProps, 'path'>): JSX.Element {
  return (
    <Icon
...
export function WhatsAppIcon(props: Omit<IconProps, 'path'>): JSX.Element {
  return (
    <Icon
