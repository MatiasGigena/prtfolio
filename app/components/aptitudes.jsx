...
const Aptitudes = () => {
  ...
  return (
    <div
      ...
      className="h-screen relative w-full mt-28 sm:ml-10 text-black">
      ...
      <div ref={plane2} className="plane">
        <Image
          ...
          height="50"
        />
        <Image src="https://www.vectorlogo.zone/logos/w3_html5/w3_html5-icon.svg" alt="HTML" width="50" height="50" />
        <Image src="https://www.vectorlogo.zone/logos/w3_css/w3_css-icon.svg" alt="CSS" width="50" height="50" />
      </div>
      <div ref={plane3} className="plane">
        ...
        <Image
          ...
          height="50"
        />
        <Image src="https://www.vectorlogo.zone/logos/framer/framer-icon.svg" alt="Framer" width="50" height="50" />
      </div>
